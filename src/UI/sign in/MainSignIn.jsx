    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-gray-100 px-2 sm:px-0 ">
      <div className="w-full max-w-sm sm:max-w-md md:max-w-lg mx-auto overflow-hidden bg-white rounded-lg shadow-md">
        ...
        <div className="px-4 sm:px-6 py-4">
          <form>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-4 gap-2 sm:gap-0">
              <Link
                to="/forgotpass"
                className="text-sm text-purple-900 hover:underline text-center sm:text-left"
              >
                Forget Password?
              </Link>
              <button className="px-6 py-2 text-sm sm:text-base font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-purple-900 rounded-lg hover:bg-purple-800 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-opacity-50 mt-2 sm:mt-0">
                Sign In
              </button>
            </div>
          </form>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center py-4 text-center bg-gray-50 gap-2 sm:gap-0">
          ...
          <Link to="/MainRegister" className="mx-2 text-sm font-bold text-purple-900 hover:underline">
            Register
          </Link>
        </div>
      </div>
